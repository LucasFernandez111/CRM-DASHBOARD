...
const CardWithStatistics: React.FC<CardWithStatisticsProps> = ({ amount, description, className }) => {
  return (
    <Card className={cn('w-72 h-40  text-center flex items-center justify-center rounded-4xl p-2', className)}>
      <CardHeader>
        <CardTitle className="text-3xl font-extrabold text-customSteelblue">{amount} </CardTitle>
